...
class MyConstant {
  // Genernal
  static String appName = 'Timeline Chana';
  static String domain = 'http://4646-185-182-193-73.ngrok.io';
  ...
  // Color
  static Color primary = Color.fromARGB(255, 49, 148, 240);
  static Color dark = Color.fromARGB(255, 39, 23, 184);
  static Color light = Color.fromARGB(255, 121, 187, 241);
  ...
  BoxDecoration planBackground() => BoxDecoration(
        color: MyConstant.light.withOpacity(0.9),
      );
