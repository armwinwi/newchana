...
class _CreateAccountState extends State<CreateAccount> {
  ...
  Future<Null> uploadPictureAndInsertData() async {
    ...
    String path =
        '${MyConstant.domain}/chana/getUserWhereUser.php?isAdd=true&user=$user';
    await Dio().get(path).then((value) async {
      ...
      if (value.toString() == 'null') {
        ...
        if (file == null) {
          ...
          String apiSaveAvatar = '${MyConstant.domain}/chana/saveAvatar.php';
          ...
          await Dio().post(apiSaveAvatar, data: data).then((value) {
            avatar = '/chana/avatar/$nameAvatar';
            processInsertMySQL(
              name: name,
              address: address,
              phone: phone,
  ...
  Future<Null> processInsertMySQL(
    ...
    String apiInsertUser =
        '${MyConstant.domain}/chana/insertUser.php?isAdd=true&name=$name&type=$typeUser&address=$address&phone=$phone&user=$user&password=$password&avatar=$avatar&lat=$lat&lng=$lng';
