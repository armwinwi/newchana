...
class BuyerService1 extends StatefulWidget {
  const BuyerService1({Key? key}) : super(key: key);
...
class _BuyerServiceState extends State<BuyerService1> {
  List<Widget> widgets = [
    MyMoneyBuyer(),
    ConfimeAddWallet(),
  ];
